...
class Coinsnap_Bitcoin_Voting_Confirmation {
    ...
    public function maybe_create_confirmation_page() {
        ...
        $page_id = wp_insert_post( [
            'post_title'   => __( 'Payment Confirmation', 'coinsnap-bitcoin-voting' ),
    ...
    public function render(): string {
        ...
        <div class="cbv-confirmation-wrap">
            <div class="cbv-confirmation-card">
                ...
                <h2><?php esc_html_e( 'Payment Successful!', 'coinsnap-bitcoin-voting' ); ?></h2>
                <p class="cbv-confirmation-sub"><?php esc_html_e( 'Your vote has been registered.', 'coinsnap-bitcoin-voting' ); ?></p>

                <table class="cbv-confirmation-table">
                    <?php if ( $poll_title ) : ?>
                    <tr>
                        <th><?php esc_html_e( 'Poll', 'coinsnap-bitcoin-voting' ); ?></th>
                        <td><?php echo esc_html( $poll_title ); ?></td>
                    </tr>
                    <?php endif; ?>
                    <?php if ( $option ) : ?>
                    <tr>
                        <th><?php esc_html_e( 'Voted for', 'coinsnap-bitcoin-voting' ); ?></th>
                        <td><?php echo esc_html( $option ); ?></td>
                    </tr>
                    <?php endif; ?>
                    <?php if ( $amount ) : ?>
                    <tr>
                        <th><?php esc_html_e( 'Amount', 'coinsnap-bitcoin-voting' ); ?></th>
                ...
                <a href="<?php echo esc_url( $back_url ); ?>" class="cbv-confirmation-back">
                    &larr; <?php esc_html_e( 'Back to poll', 'coinsnap-bitcoin-voting' ); ?>
                </a>
                <?php else : ?>
                <a href="<?php echo esc_url( home_url() ); ?>" class="cbv-confirmation-back">
                    &larr; <?php esc_html_e( 'Back to home', 'coinsnap-bitcoin-voting' ); ?>
                </a>
                <?php endif; ?>
            </div>
        </div>
