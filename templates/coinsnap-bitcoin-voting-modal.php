...
<div id="<?php echo esc_html($prefix); ?>qr-container<?php echo esc_html($sufix); ?>" class="qr-container coinsnap-bitcoin-voting" data-public-donors="<?php echo esc_attr($public_donors); ?>">
    ...
    <div id="<?php echo esc_html($prefix); ?>public-donor-popup<?php echo esc_html($sufix); ?>" class="public-donor-popup">
        ...
        <?php if ($custom !== 'hidden'): ?>
                <label for="<?php echo esc_html($prefix); ?>custom<?php echo esc_html($sufix); ?>"><?php echo esc_html($custom_name);?></label>
                <input <?php echo $custom === 'mandatory' ? 'required="required"' : ''; ?> type="text"
